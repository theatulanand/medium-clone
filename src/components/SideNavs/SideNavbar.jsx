...
<<<<<<< HEAD:src/components/SideNavbar.jsx
            {/* <div style={{ marginBottom: "1.5rem" , marginLeft: "20px" }}>
=======
            <div style={{ marginBottom: "1.5rem" }} className='navIcons'>
                <HorizontalRuleIcon style={{ color: "grey" }} />
            </div>
            <div style={{ marginBottom: "1.5rem" }} className='navIcons'>
>>>>>>> d07e1aa8fe39703b36cdbf671907d7e4aa63ddcc:src/components/SideNavs/SideNavbar.jsx
