...
export const SideSearchbar = () => {
  ...
  return (
    <div style={{ paddingLeft: "2rem" }}>
      <button style={{ backgroundColor: "black", color: "white", width: "90%", border: "none", borderRadius: "20px", padding: "0.7rem", marginTop: "2rem", marginBottom: "2rem" }}>Get unlimited access</button>
      <br />
      <input type="text" placeholder="Search" style={{ width: "80%", borderRadius: "100px", marginBottom: "1rem", padding: "0.7rem", fontSize: "16px", paddingLeft: "2rem", border: " 1px solid gainsboro" }} />
      <h4 style={{ fontWeight: "500" }}>What We're Reading Today</h4>
      <div>
        <span>
          <img style={{ width: "5%", borderRadius: "100%", textAlign: "center", justifyContent: "center" }} src="https://www.jetsetter.com//uploads/sites/7/2019/04/GettyImages-920879930-1380x1380.jpg" alt="" />
        </span>
      ...
      <div style={{ paddingLeft: "1rem", paddingTop: "1px", width: "90%", backgroundColor: "#c4e8ed", marginTop: "3rem", borderRadius: "5px" }} >
      ...
      <div style={{ display: "flex", flexDirection: "row", paddingBottom: "3rem", flexWrap: "wrap", width: "90%" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "15% 60% 25%", width: "90%", marginBottom: "1rem" }}>
        <span>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "15% 60% 25%", width: "90%", marginBottom: "1.5rem" }}>
        <span>
